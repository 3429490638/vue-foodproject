  ...
  <div v-show="showFlag" class="food" transition="move" v-el:food>
    <div class="food-content">
      ...
      <div class="content">
        ...
        <div @click="addFirst" class="buy"
             v-show="!food.count || food.count===0" transition="fade">加入购物车
        </div>
      </div>
      ...
      <div class="rating">
        ...
        <div class="rating-wrapper">
          <ul v-show="food.ratings && food.ratings.length">
            <li v-show="needShow(rating.tateType,rating.text)" v-for="rating in food.ratings"
